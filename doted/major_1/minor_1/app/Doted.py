...
from doted.major_1.minor_1.view.widget.GraphicsGraphView import GraphicsGraphView
from doted.major_1.minor_1.view.widget.TextGraphView import TextGraphView
